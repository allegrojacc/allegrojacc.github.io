...
function processCommand(command) {
  ...
  switch (args[0]) {
    case "spage":
      ...
      newTab("https://allegrojacc.online/socials");
      break;
    case "terminal":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
      renderMultipleLines(TERMINAL, 80);
      break;
    case "help":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
    ...
    case "pwd":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
      renderLine("<br>/home/allegrojacc/allegrojacc.online<br><br>");
      break
    case "echo":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
    ...
    case "stulej":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
      open("https://allegrojacc.online/stulej")
    case "cd":
      commandIndex = addCommandToHistory(args,comandHistory, commandIndex);
      if (args[1] === "games") {
        renderLine("Opennig steam...", 80);
        newTab("https://steamcommunity.com/id/allegrojacc/");
      } else {
